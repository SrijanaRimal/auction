                    ...
                    <div class="row" id="error-page">
                        <div class="col-sm-6 col-sm-offset-3">
                            <div class="box">
                                ...
                                <p class="text-center">To continue please use the <strong>Search form</strong> or
                                    <strong>Menu</strong> above.
                                </p>

                                <p class="buttons"><a href="index.html" class="btn btn-primary"><i
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <p class="social">
                            ...
                            <a href="#" class="gplus external" data-animate-hover="shake"><i
