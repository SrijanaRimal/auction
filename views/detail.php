                ...
                <div class="row" id="productMain">
                    <div class="col-sm-6">
                        <div id="mainImage">
                            ...
                            <img src="<?php echo BASE_URI; ?>views/img/<?php echo $singleProduct->image ;?>" alt=""
                    ...
                    <div class="col-sm-6">
                        <div class="box">
                            ...
                            <p class="price">Current Bid : Rs
                                ...
                                <?php echo $singleBid->current_bid ; ?>
                            </p>
                            ...
                            <form action="" method="post" align="center">
                                ...
                                <input class="btn btn-primary" type="submit" align="center" name="bidnow"
                                    value="Bid Now"><br /><br>
                            </form>
                            ...
                            var current =
                                "Auction Ended !"; //-->enter what you want the script to display when the target date and time are reached, limit to 20 characters
                                ...
                                <div class="flipper">
                                    <div class="front">
                                        ...
                                        <a href="<?php echo BASE_URI;?>detail.html">
                                            <img src="<?php echo BASE_URI;?>views/img/<?php echo $product->image;?>"
